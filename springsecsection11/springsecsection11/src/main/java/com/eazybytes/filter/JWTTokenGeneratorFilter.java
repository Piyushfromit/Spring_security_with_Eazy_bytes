...
public class JWTTokenGeneratorFilter extends OncePerRequestFilter {
    ...
    // using shouldNotFilter, it will not filtering for true reurned value, it will jist work for false value
    @Override
    protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
        return !request.getServletPath().equals("/user");     // this is login path, change accordingly
    }
